...
nextAnimal = favoriteAnimals[getRandomIntInclusive(favoriteAnimals.length - 1)];
...
expect(
  (favoriteAnimals.indexOf(nextAnimal) + 1),
   'You went to see the ' + nextAnimal + ' but they are not one of your favorite animals...',
   'YIPPEE! You got to see the ' + nextAnimal + ' which are one of your favorite animals');
